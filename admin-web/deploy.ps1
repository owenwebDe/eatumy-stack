...
$REMOTE_DIR = "/home/admins/admin-web"

Write-Host "Deploying Admin Panel to VPS ($VPS_IP)..." -ForegroundColor Cyan
...
Write-Host "🌐 Admin Panel live at http://$VPS_IP:3001" -ForegroundColor Green
