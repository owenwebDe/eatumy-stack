                        ...
                        <Card className="border-none shadow-sm hover:shadow-md transition-shadow cursor-pointer overflow-hidden">
                          <CardContent className="p-0 flex">
                            <div className="w-24 h-24 relative bg-muted">
                              {hotel.logoUrl ? (
                                <img src={getMediaUrl(hotel.logoUrl)} className="w-full h-full object-cover" alt="" />
                              ) : (
                ...
                >
                  <Card className="border-none shadow-sm hover:shadow-md transition-shadow cursor-pointer overflow-hidden">
                    <CardContent className="p-0 flex">
                      <div className="w-24 h-24 relative bg-muted">
                        {item.hotel.logoUrl ? (
                          <img src={getMediaUrl(item.hotel.logoUrl)} className="w-full h-full object-cover" alt="" />
                        ) : (
